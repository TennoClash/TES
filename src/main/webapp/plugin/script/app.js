particlesJS('particles-js',
  ...
  "particles": {
    ...
    "move": { 
      "enable": true, //原子移动
      "speed": 1.5, //原子移动速度
      "direction": "bottom", //原子移动方向   "none" ,"top" ,"top-right" ,"right" ,"bottom-right" ,"bottom" ,"bottom-left" ,"left" ,"top-left"
      "random": true, //移动随机方向
      "straight": false, //直接移动
  ...
  "interactivity": {
    ...
    "events": {
      ...
      "onclick": {
        "enable": false,  //点击效果
        "mode": "bubble"  //点击效果模式   "push" ,"remove" ,"bubble" ,"repulse" ,["push", "repulse"]
      },
      "resize": true // 互动事件调整
    },
    "modes": {
