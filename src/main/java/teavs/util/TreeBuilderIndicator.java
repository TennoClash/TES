...
public class TreeBuilderIndicator {
	List<Indicator> nodes = new ArrayList<>();

    public String buildTree(List<Indicator> nodes) {

        TreeBuilderIndicator treeBuilder = new TreeBuilderIndicator(nodes);

        return treeBuilder.buildJSONTree();
    }

    public TreeBuilderIndicator() {
    }

    public TreeBuilderIndicator(List<Indicator> nodes) {
        super();
        this.nodes = nodes;
    }
